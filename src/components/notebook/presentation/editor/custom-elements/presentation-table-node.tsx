    ...
    const content = (
      ...
      >
        <div className="group/table relative w-full bg-transparent">
          <table
            className={cn(
              "mr-0 ml-px table h-px max-w-[calc(100%-2rem)] table-fixed border-collapse bg-transparent text-(--presentation-text)",
...
function RowDragHandle({ dragRef }: { dragRef: React.Ref<any> }) {
  ...
  return (
    ...
    >
      <GripVertical className="text-muted-foreground" data-ppt-ignore="true" />
    </Button>
  );
}
  ...
  return (
    <PlateElement
      ...
      className={cn(
        ...
        element.background
          ? "bg-(--presentation-card-background)"
          : "bg-transparent",
