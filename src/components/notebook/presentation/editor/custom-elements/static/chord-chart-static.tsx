...
interface ChordChartElement {
  data?: unknown;
  showLegend?: boolean;
  disableAnimation?: boolean;
}

export default function ChordChartStatic(props: SlateElementProps) {
  const element = props.element as unknown as ChordChartElement;
