...
interface ConeFunnelChartElement {
  data?: unknown;
...
export default function ConeFunnelChartStatic(props: SlateElementProps) {
  const element = props.element as unknown as ConeFunnelChartElement;
