...
interface NightingaleChartElement {
  data?: unknown;
  showLegend?: boolean;
  color?: string;
...
export default function NightingaleChartStatic(props: SlateElementProps) {
  const element = props.element as unknown as NightingaleChartElement;
